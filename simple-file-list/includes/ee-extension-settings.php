...
if(isset($_POST['eePost']) AND check_admin_referer( 'ee-simple-file-list-settings', 'ee-simple-file-list-settings-nonce')) {
	...
	$eeSFL_BASE->eeLog[eeSFL_BASE_Go]['messages'][] = __('Extension Settings Saved', 'simple-file-list');
}
...
<div class="eeColInline eeSettingsTile">
	...
	<div class="eeColHalfLeft">
		...
		<h1>' . __('Extension Settings', 'simple-file-list') . '</h1>
		<a class="" href="https://simplefilelist.com/extensions/" target="_blank">' . __('Information', 'simple-file-list') . '</a>
